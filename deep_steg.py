...
for epoch in range(5):
    ...
    autoencoder_model.save_weights('models/model'+str(epoch+6))

    loss_history.append(np.mean(ae_loss))

autoencoder_model.load_weights('models/model11')
...
for epoch in range(20):
    ...
    autoencoder_model.save_weights('models/model'+str(epoch+12))
...
for epoch in range(50):
    ...
    autoencoder_model.save_weights('models/model'+str(epoch+32))
...
autoencoder_model.load_weights('models/model_A_67')
